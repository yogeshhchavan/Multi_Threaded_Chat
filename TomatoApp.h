...
#include "managers/RestuarantManager.h"
...
public:
    ...
    void initializeRestaurants() {
        Restaurant* restaurant1 = new Restaurant("Binker", "Delhi");
        ...
        Restaurant* restaurant3 = new Restaurant("Saravanna Bhavan", "Chennai");
        restaurant3->addMenuItem(MenuItem("P1", "Masal Dosa", 90));
    ...
    Order* checkout(User* user, const string& orderType,
        ...
        void payForOrder(User* user, Order* order){
            ...
            // clear the user cart if payment is Successful
